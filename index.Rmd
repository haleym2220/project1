...
glimpse(song_match)
```
*In this section, I wanted to create multiple different columns in order to see data throughout the year. Since msPlayed represents milliseconds, I divided by 1000 to get seconds instead. I separated Date into Date and Time because it was too much information in one column. I separated Date again into year, month, and day and Time into hour, min, and sec. I did this because I felt that it would be easier to analyze data throughout days and the past year of data with different variables. I deleted the Date, msPlayed, Sec, Time, and Year columns because I felt that they were redundant or unnecessary since I had mutated or separated them. I also deleted the has_year and play_count_has_year in it because I felt that those columns did not pertain to the comparison between the data as they were both logical vectors.* 
